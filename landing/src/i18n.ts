...
export const translations = {
  en: {
    ...
    features: {
      ...
      desc: 'Multiple AI capabilities in one seamless voice experience on your smart glasses.',
      items: [
        {
    ...
    howItWorks: {
      ...
      steps: [
        { title: 'Wear', desc: 'Put on your Mentra Live smart glasses — lightweight and comfortable for all-day use.' },
        { title: 'Speak', desc: 'Use voice commands or button presses to trigger any of Suhail\'s AI features.' },
        { title: 'Process', desc: 'The camera captures the scene and cloud AI analyzes it in seconds.' },
        { title: 'Listen', desc: 'Results are spoken back to you through the glasses\' built-in speakers.' },
      ],
    },
    team: {
      label: 'Team',
  ...
  ar: {
    ...
    howItWorks: {
      ...
      steps: [
        { title: 'البس', desc: 'البس نظارات Mentra Live الذكية — خفيفة ومريحة طول اليوم.' },
        { title: 'تكلّم', desc: 'استخدم الأوامر الصوتية أو الأزرار عشان تشغّل أي ميزة من مميزات سهيل.' },
        { title: 'المعالجة', desc: 'الكاميرا تلتقط المشهد والذكاء الاصطناعي يحلله في ثواني.' },
        { title: 'اسمع', desc: 'النتيجة توصلك بالصوت من سماعات النظارة.' },
      ],
    },
    team: {
      label: 'الفريق',
